...
1. **Add a banner placement to your config**
   ...
   This is a minimal but complete `ExportedConfig` — author the same shape in the [studio](https://www.revturbine.com/app) or with the CLI. The banner is a `fixed` placement bound to a named slot, targeted at the Pro plan.
