...
2. **Create an Playbook fixture**
   ...
   For local development, you need a config file with plans, entitlements, and placements. Create `src/fixtures/playbook.json`:
...
3. **Wrap your app with the provider**
   ...
   import playbook from './fixtures/playbook.json';
