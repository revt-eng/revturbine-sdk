...
|---|---|---|---|
| **`local_only`** | Getting started, offline, **and production** when a bundled Playbook is enough | No decisioning network; optional anonymous adoption beacon | `localRuntime: { playbook }` |
