...
- **RevTurbine owns *policy*, not money.** The plan catalog, what each plan entitles, and when a placement shows are all RevTurbine's — a PM edits them in the dashboard and republishes, with no code deploy. RevTurbine never charges anyone.
