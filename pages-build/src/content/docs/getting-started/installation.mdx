...
The **`@revturbine/cli`** package manages your RevTurbine configuration (plans, entitlements, placements) and change sets from the terminal — verify, diff, upload, and deploy an `Playbook`.
