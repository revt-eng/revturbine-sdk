...
```bash
npx @revturbine/cli validate ./revturbine.playbook.json
```
...
See the [CLI reference](/reference/cli/) for the full command surface, file-selector rules, generated handle types, and the draft → Release lifecycle.
