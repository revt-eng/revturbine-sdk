...
```tsx
import { usePlacement } from '@revt-eng/sdk';
...
```tsx
import { useEntitlement } from '@revt-eng/sdk';
...
```tsx
import { useUsageSnapshot } from '@revt-eng/sdk';
...
```tsx
import { SurfaceSlotComponent } from '@revt-eng/sdk';
