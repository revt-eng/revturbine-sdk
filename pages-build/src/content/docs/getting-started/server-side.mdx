...
The SDK supports server-side entitlement checks and placement decisions using the **local runtime** mode — all logic runs against a Playbook snapshot with no network calls required for decisioning.
